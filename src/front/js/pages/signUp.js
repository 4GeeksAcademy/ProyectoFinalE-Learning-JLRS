    ...
    return (
        <div>
            <form className="container d-flex flex-column align-items-center mt-5 p-3" id="formularioRegistro" onSubmit={handleSubmit}>
                ...
                <label>Email
                    <input className="form-control" name="email" value={dataForm.email} placeholder="Introduce tu email aquí" onChange={handleChange} type="text" />
                </label>
                <label>Contraseña
                    <div className="contenedor-password2">
                        <input className="form-control" name="password" value={dataForm.password} placeholder="" onChange={handleChange} type={visible ? "text" : "password"} />
                        {visible ? 
                ...
                <label>Confirma contraseña
                    <div className="contenedor-password2">
                        <input className="form-control" name="confirmPassword" value={dataForm.confirmPassword} placeholder="" onChange={handleChange} type={visible ? "text" : "password"} />
                        {visible ? 
                            <span className="fa-solid fa-eye-slash icon2" onClick={handleClick}></span> 
                            : 
                            <span className="fa-solid fa-eye icon" onClick={handleClick}></span>}
